...
import com.meteoro.omdbarch.domain.connectivity.base.ConnectivityProvider.NetworkState.ConnectedState.ConnectedLegacy
...
class ConnectivityProviderLegacyImpl(
    ...
    private inner class ConnectivityReceiver : BroadcastReceiver() {
        override fun onReceive(context: Context, intent: Intent) {
            // on some devices ConnectivityManager.getActivityNetworkInfo() does not provide the correct network state
