...
class HandleDelegatedWorkTests {
    ...
    @Test
    fun `should handle delegated work with results`() {
        val work = DefineDetail
    ...
    @Test
    fun `should handle delegated work with no results`() {
        val work = DefineDetail
    ...
    @Test
    fun `should report no results for diferent flow tag`() {
        val work = DefineDetail
