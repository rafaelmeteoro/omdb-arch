...
internal class CorInfrastructureRule : ExternalResource() {

    private lateinit var server: MockWebServer
    lateinit var api: OmdbCoroutineAPI
    ...
    override fun before() {
        ...
        api = CorBuildRetrofit(url, client).create(OmdbCoroutineAPI::class.java)
    }
